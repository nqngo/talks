    ...
    <div class="col">
        <ul>
            <li>
                ...
                <div>
                    <small class="tiny">
                        <a href="https://pt.behindtheclouds.dev/2022-yubikey-one?print-pdf&showNotes=separate-page">https://pt.behindtheclouds.dev/2022-yubikey-one?print-pdf&showNotes=separate-page</a>
                    </small>
                </div>
            </li>
